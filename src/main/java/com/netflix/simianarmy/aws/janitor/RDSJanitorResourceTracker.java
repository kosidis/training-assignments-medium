...
public class RDSJanitorResourceTracker implements JanitorResourceTracker {
	...
	private void updateResource(Resource resource, String json) {
		StringBuilder sb = createUpdateStatement();

		executeUpdateStatement(resource, json, sb);
	}

	private void addResource(Resource resource, String json) {
		StringBuilder sb = createInsertStatement();

		executeInsertStatement(resource, json, sb);
	}

	private void executeUpdateStatement(Resource resource, String json, StringBuilder sb) {
	...
	private void executeInsertStatement(Resource resource, String json, StringBuilder sb) {
	...
	private StringBuilder createUpdateStatement() {
	...
	private StringBuilder createInsertStatement() {
		StringBuilder sb = new StringBuilder();
